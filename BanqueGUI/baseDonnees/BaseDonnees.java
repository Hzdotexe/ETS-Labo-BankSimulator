...
/**
 * Cette classe propose une interface à la base de données.
 * 
 ...
 *             qu'il n'y aura qu'une base de données et pour faciliter l'accés 
 *             à l'objet.
 *             
 *
...
public class BaseDonnees {
	 ...
	 * @param nouvelUtilisateur l'utilisateur é ajouter
	 ...
	 * @param numeroDeCompte numéro de compte de l'utilisateur pour lequel 
	 *                       on veut les transactions
